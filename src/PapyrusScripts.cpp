...
namespace Mus {
    namespace Papyrus {
        ...
        std::vector<std::string> GetFacialExpressionmorphCategories(RE::StaticFunctionTag*) {
            return MFEE::FEE.GetFacialExpressionCategories();
        };
        std::size_t GetFacialExpressionmorphCategoriesSize(RE::StaticFunctionTag*) {
        ...
        bool RegisterPapyrusFunctions(RE::BSScript::IVirtualMachine* vm) {
            ...
            vm->RegisterFunction("GetFacialExpressionmorphCategories", ScriptFileName, GetFacialExpressionmorphCategories);
            vm->RegisterFunction("GetFacialExpressionmorphCategoriesSize", ScriptFileName, GetFacialExpressionmorphCategoriesSize);
